...
public class Bus {
  ...
  public static final int LIMIT = 25; // 25개 좌석 (상수값 적용)
  private int numOfPerson;            // 승객 수 
  ...
  public void on(Person person) throws RuntimeException {
    ...
    for(int i = 0; i < LIMIT; i++) {
      ...
      Seat seat = seats.get(i);        // seats.get(i) = 의자 
      
      if(seat.getPerson() == null) {  // seats.get(i).getPerson() = 의자에 앉은 사람       
