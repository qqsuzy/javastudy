...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    /*
     * 기본 자료형 변환
     * 1. 자동 변환(묵시적 형 변환)이 있다. - java가 알아서 해준다.(코드 입력이 필요없음)
     *    1) promotion
     *    2) 값의 도메인(domain : 값의 범위)이 작은 타입을 큰 타입으로 바꿀 떄 동작한다.
     *    3) byte -> short -> int -> long -> float -> double (메모리 사이즈가 아닌 값의 범위)
     *    
     * 2. 강제 변환이 있다. (코드 입력이 필요함)
     *    1) casting
    ...
    /*
     * 문자열을 Number 타입으로 변환하기 (많이 사용됨!!!) parsing 파싱
     * 1. int로 변환하기
     *    Integer.parseInt("1")     -> int 타입(숫자) 1 반환
     *    
     * 2. long으로 변환하기
    ...
    System.out.println(n2); // 문장 복사 : ctrl + alt + 위,아래 방향키
