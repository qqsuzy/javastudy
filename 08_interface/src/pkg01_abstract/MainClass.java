...
public class MainClass {
  ...
  public static void main(String[] args) {
    ...
    if(shape1 instanceof Circle) {
      ...
      System.out.println( "Radius : " + ((Circle) shape1).getRadius() ); // Circle만 가지고 있는 메소드
    ...
    if(shape2 instanceof Rectangle) {
      ...
      System.out.println( "Y2 : " + ((Rectangle) shape2).getY2() ); // Rectangle만 가지고 있는 메소드
      
      // 공통 메소드는 부모에게 주자! getArea() , getCircum()
    }
