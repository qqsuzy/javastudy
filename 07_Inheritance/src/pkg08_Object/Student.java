...
public class Student {
  ...
  public void removeBook (Book book) {
    ...
    for(int i = 0; i < bookCount; i++) { // books.length 는 아니다. bookCount로 저장된 책만큼만 체크한다.
      if(book.equals(books[i])) {        // 같은 책을 발견했으면~ , Book 클래스에 Object 클래스의 equals 메소드 오버라이드 해야 한다. (isbn 이 같으면 true 반환)
  ...
  public String toString() {
    return "stuNo: " + stuNo + ", name: " + name; // return 반환으로 구성해야한다. (system.out.println 사용 x)
  }
